...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function addObstacles() {
      ...
      this.add(new _obstacle2.default(x));
      this.fencesToGo -= 1;
    }
  }, {
    key: "removeObstacles",
    ...
    value: function won() {
      ...
      if (this.fencesToGo <= 0) {
        ...
        houseSprite.onload = function () {
          _this3.ctx.drawImage(houseSprite, 500, 120, 500, 500);
        };

        var winDogSprite = new Image();
        winDogSprite.onload = function () {
          _this3.ctx.drawImage(winDogSprite, 20, 390, 150, 150);
        };

        var winSprite = new Image();
        winSprite.onload = function () {
          _this3.ctx.drawImage(winSprite, 240, 0, 300, 300);
        };

        var startSprite = new Image();
        startSprite.onload = function () {
          _this3.ctx.drawImage(startSprite, 280, 350, 200, 100);
        };
    ...
    value: function gameOver() {
      ...
      gameOverSprite.onload = function () {
        _this4.ctx.drawImage(gameOverSprite, 300, 80, 200, 100);
      };

      var sadDogSprite = new Image();
      sadDogSprite.onload = function () {
        _this4.ctx.drawImage(sadDogSprite, 20, 360, 200, 200);
      };
...
var Obstacle = function (_MovingObject) {
  ...
  function Obstacle(x) {
    ...
    _this.obstacleSprite.src = "src/images/bush.png";
    return _this;
  }
